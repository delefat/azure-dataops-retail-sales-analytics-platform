...
This project is an original Azure DataOps portfolio implementation inspired by modern data warehouse engineering patterns, using Azure Data Factory, Databricks, Azure Data Lake Storage Gen2 (ADLS Gen2), Azure Synapse Analytics, Power BI, CI/CD, testing, monitoring, and data governance.
